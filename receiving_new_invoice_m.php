    ...
    <script>  
        $(document).ready(function(){  
            ...
            $('#submit').click(function(){            
                $.ajax({  
                    url:"receiving_new_invoice_query_m.php",  
                    method:"POST",  
