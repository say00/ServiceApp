...
<body>
    <?
        ...
        $id_partU = $_GET['id_part']? $_GET['id_part']: $_POST['id_part'];
  ...
  <div id="main">
    ...
    <div id="site_content">
        <?php
            ...
            $queryU = mysqli_query($dbConnection, "SELECT id_part, Ordered_part, Received_part, Returning_part, Description_part, Kayako, rma FROM ServiceApp_ASUS_BAD_RTV WHERE id_part='$id_partU'");
            ...
            $stmt->bind_param('issssssis', $id_partU, $part_noOU, $part_noRU, $part_Return, $part_descU, $kayakoU, $rmaU, $qtyU, $date_shortI);
            $stmt->execute();
